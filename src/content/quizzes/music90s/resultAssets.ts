...
export const MUSIC90_RESULT_ASSETS: Record<Music90ResultId, Music90AssetSet> = {
  m90_rookie: {
    ...
    layout: { heroClass: 'm90-result-hero--rookie' },
  },
  m90_familiar: {
    id: 'm90_familiar',
    rangeFolder: '5-7',
    ...
    hero: {
      src: OBJECTS_FALLBACK.boombox,
      fallback: OBJECTS_FALLBACK.boombox,
    ...
    layout: { heroClass: 'm90-result-hero--familiar' },
  },
  m90_cassette: {
    id: 'm90_cassette',
    rangeFolder: '8-10',
